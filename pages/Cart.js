  ...
  return (
    ...
    <div className="container mx-auto lg:w-1/2 w-full pb-24">
          ...
          products.map(product =>{
           ...
           return(
            ...
            <div className="flex items-center justify-between">
              ...
              <button  onClick={() => { handleDelete(product._id) }}  className="bg-red-500 px-4 py-2 rounded-full leading-none">Delete</button>
            </div>
          </li>
      ...
      <div className="text-right mt-6">
        <button onClick={handleOrderNow} className="bg-red-500 px-4 py-2 rounded-full leading-none">Order Now</button>
      </div>
    </div>
  )
};
